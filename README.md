...
Implement physical interaction with utensils, ingredients, and plates (grab, release, throw, place in specific spots).

Ensure comfortable locomotion inside the kitchen (teleport or continuous movement with snap turning).
...
C# with modular architecture and event-based communication.
...
At least three advanced physical interaction mechanics: grabbing/throwing ingredients, operating equipment (stove, oven, buttons, levers), and placing finished dishes in specific delivery zones.

Game Manager to handle states (start, round in progress, game over, win/lose).
...
Phase 2 – Prototype (Greyboxing): basic kitchen layout with simple geometry and functional locomotion and core interactions.

Phase 3 – Final Version: APK build, technical report, and playable demo with all systems integrated.
